...
class NumaParser
{
    ...
    private void Configure()
    {
        ...
        parser.AddOption(OptionFactory.CreateListOption<NumaCtlArgs, int>(int.Parse) with
        {
        ...
        parser.AddOption(OptionFactory.CreateIntOption<NumaCtlArgs>() with
        {
        ...
        parser.AddArgument(ArgumentFactory.CreateStringArgument<NumaCtlArgs>() with
        {
        ...
        parser.AddArgument(ArgumentFactory.CreateListArgument<NumaCtlArgs, string>(s => s) with
        {
